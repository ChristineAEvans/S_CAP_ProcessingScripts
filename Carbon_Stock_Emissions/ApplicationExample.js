...
var Expansion_chart = ui.Chart.image.histogram({image: total_mining_2024.mean().unmask(),
                                          region: AOI,
                                          scale: 100,
                                          // maxBuckets: 100,
                                          // minBucketWidth: 50,
...
var AGB_gedi = GEDI2020.updateMask(total_mining_2024.mean());
var CCI20 = CCI.filterDate('2019-01-01','2021-01-01').first().select(['AGB']);
var AGB_cci = CCI20.updateMask(total_mining_2024.mean());
var AGB_xu = XU20.updateMask(total_mining_2024.mean());
...
// var CCI20 = CCI.filterDate('2019-01-01','2021-01-01').first().select(['AGB']);
// var AGB_cci10 = CCI10.updateMask(total_mining_2024.mean());
// var AGB_cci20 = CCI20.updateMask(total_mining_2024.mean());
